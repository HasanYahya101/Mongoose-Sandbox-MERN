    ...
    <header className="h-14 flex items-center justify-between px-4 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 z-10">
      <div className="flex items-center space-x-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-xl font-semibold text-slate-800 dark:text-white sm:whitespace-normal sm:overflow-visible sm:text-clip truncate whitespace-nowrap overflow-hidden text-ellipsis">MongoDB API Tester</h1>
        </div>
      </div>
